...
function CourseCard({ course }) {
  ...
  const className = {
    article:
      "flex cursor-pointer flex-col overflow-hidden rounded-[20px] border border-[#ede8e0] bg-white shadow-[0_1px_3px_rgba(0,0,0,0.06)] transition-all duration-250 hover:-translate-y-1.5 hover:border-[rgba(76,175,80,0.2)] hover:shadow-[0_16px_48px_rgba(30,107,74,0.15),0_4px_16px_rgba(0,0,0,0.08)]",
  ...
  return (
    <article className={className.article}>
      ...
      <div className="flex flex-1 flex-col gap-3 p-5">
        ...
        <h3 className="text-[17px] leading-snug font-extrabold text-[#1a1f2e]">
          {lang === "en" ? titleEn : titleAr}
        </h3>

        <p className="line-clamp-2 text-[13px] leading-relaxed text-[#8a93a6]">
          {lang === "en" ? descriptionEn : descriptionAr}
        </p>

        {/* Meta */}
        <div className="flex items-center gap-4 border-t border-[#ede8e0] pt-3">
        ...
        <div className="flex items-center gap-2.5">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border-2 border-[#e2d9cc] bg-[#f0ede6] text-sm">
            {teacherImage}
          </div>
          <div className="min-w-0 flex-1">
            <div className="truncate text-[13px] font-bold text-[#1a1f2e]">
