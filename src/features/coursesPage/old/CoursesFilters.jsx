...
function CoursesFilters() {
  ...
  const className = {
    container: "mx-auto max-w-7xl px-8 pt-8",

    subContainer: "no-scrollbar flex items-center gap-2.5 overflow-x-auto pb-2",

    button:
      "hover:border-primary-green hover:text-primary-green inline-flex shrink-0 cursor-pointer items-center gap-2 rounded-full border border-[#e2d9cc] bg-white px-5.5 py-2.5 text-sm font-semibold whitespace-nowrap text-[#4a5568] transition-all duration-250 hover:bg-[rgba(76,175,80,0.04)]",

    activeButton:
      "border-primary-green bg-primary-green inline-flex shrink-0 items-center gap-2 rounded-full border px-5.5 py-2.5 text-sm font-semibold whitespace-nowrap text-white shadow-[0_2px_10px_rgba(76,175,80,0.3)] transition-all duration-250",

    numberCourses:
      "rounded-full bg-[#f0ede6] px-2 py-px text-xs font-bold text-[#8a93a6]",
