...
function CoursesHero() {
  ...
  const className = {
    ...
    badge:
      "mb-5 inline-flex items-center gap-1.5 rounded-full border border-white/25 bg-white/15 px-4 py-1.5 text-[13px] font-semibold text-white/90 backdrop-blur-sm",
    title:
