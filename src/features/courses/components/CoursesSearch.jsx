...
function CoursesSearch() {
  ...
  const className = {
    ...
    input: `flex-1 bg-transparent py-2.5 max-380:py-1 text-[15px] font-medium outline-none placeholder:font-normal ${isDark ? "text-[#f0ede6] placeholder:text-[#5a7560]" : "text-[#1a1f2e] placeholder:text-[#8a93a6]"}`,
    searchButton:
